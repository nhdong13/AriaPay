...
ActiveRecord::Schema.define(version: 2021_12_20_040834) do
  ...
  create_table "property_managers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["company_id"], name: "index_property_managers_on_company_id"
    t.index ["user_id"], name: "index_property_managers_on_user_id"
  end
