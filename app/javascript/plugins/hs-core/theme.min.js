    ...
    t.HSCore.components.HSDatatables = {
            ...
            if (e.length) {
                ...
                var o = e.DataTable(i)
                  ...
                  , l = function() {
                    ...
                    l.unwrap(l.parent()),
                    l.each((function() {
                        t(this).hasClass("current") ? (t(this).removeClass("current"),
                        t(this).wrap('<li class="paginate_item ' + i.paginationItemsClasses + ' active"></li>')) : t(this).wrap('<li class="paginate_item ' + i.paginationItemsClasses + '"></li>')
                    }
                    )),
                    ...
                    i.scrollY && e.find(t(".dataTables_scrollBody thead tr")).css({
                        visibility: "hidden"
                    })
                };
                return l(),
            ...
            if (a) {
                ...
                t(e).on("click", a, (function() {
                    var e = t(this).closest("tr")
                      , a = s.row(e);
                    a.child.isShown() ? (a.child.hide(),
                    e.removeClass("opened")) : (a.child(n.format(e.data("details"))).show(),
                    e.addClass("opened"))
                }
                ))
            }
        ...
        select: function(e, a) {
            t(e.classMap.checkAll).on("click", (function() {
                t(this).is(":checked") ? (a.rows().select(),
                a.rows().nodes().each((function(a) {
        ...
        init: function(e, a) {
            if (t(e).length) {
                ...
                return r.on("success", (function() {
                    (o.successText || o.successClass) && (o.successText && ("tooltip" === o.type ? (s.attr("data-original-title", o.successText).tooltip("show"),
                    s.on("mouseleave", (function() {
                        s.attr("data-original-title", o.title)
                    }
                    ))) : "popover" === o.type ? (s.attr("data-original-title", o.successText).popover("show"),
                    s.on("mouseleave", (function() {
                    ...
                    ), 800)) : (s.removeClass(o.defaultClass).addClass(o.successClass),
                    setTimeout((function() {
    ...
    t.HSCore.components.HSSelect2 = {
        ...
        init: function(e, a) {
            if (e.length) {
                ...
                o.singleMultiple && (s.singleMultiple(e, o),
        ...
        singleMultiple: function(e, a) {
            ...
            n.find(".select2-selection__rendered").replaceWith('<span class="select2-selection__rendered" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">' + i + '</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>')
        },
        formatData: function(e) {
            var a, s = e;
            return s.element ? (a = s.element.dataset.optionTemplate ? s.element.dataset.optionTemplate : "<span>" + s.text + "</span>",
            t.parseHTML(a)) : s.text
        },
    ...
    t.HSCore.components.HSTagify = {
        ...
        init: function(e, a) {
            if (e.length) {
                ...
                return t(i.clearBtnSelector).on("click", o.removeAllTags.bind(o)),
                i.hasManualList && (this._renderSuggestionsList(e, o),
                e.on("add", (function() {
...
function(t) {
    t.HSCore.components.HSValidation = {
        ...
        errorPlacement: function(e, a) {
            ...
            e.addClass(s),
            e.appendTo(a.parents(".js-form-message"))
        },
        highlight: function(e) {
            var a = t(e)
              ...
              , o = a;
            void 0 !== i.data("validate-state") ? o = i : i.find("[data-validate-state]").length && (o = i.find("[data-validate-state]")),
                            ...
                            yAxes: [{
                                ticks: {
                                    callback: function(t, e, a) {
                                        ...
                                        return s && t > 100 && (t = t < 1e6 ? t / 1e3 + "k" : t / 1e6 + "kk"),
                                        n && o ? n + t + o : n ? n + t : o ? t + o : t
                                    }
                                }
                            }]
                        },
                            ...
                            custom: function(t) {
                                ...
                                t.body) {
                                    ...
                                    n.forEach((function(e, a) {
                                        ...
                                        r += (i.options.tooltips.hasIndicator ? '<span class="d-inline-block rounded-circle mr-1" style="width: ' + i.options.tooltips.indicatorWidth + "; height: " + i.options.tooltips.indicatorHeight + "; background-color: " + o + '"></span>' : "") + i.options.tooltips.prefix + (s.length > 3 ? n : e) + i.options.tooltips.postfix,
                                        r += "</div>"
                                    }
                                    )),
                                    r += "</div>",
                ...
                if ("line" === i.type && i.options.tooltips.lineMode) {
                    ...
                    o.draw = function(e) {
                        ...
                        this.chart.tooltip._active && this.chart.tooltip._active.length) {
                            ...
                            s.offset().left + s.width() > a.offset().left + a.width() - 100 ? t(".hs-chartjs-tooltip").removeClass("hs-chartjs-tooltip-right").addClass("hs-chartjs-tooltip-left") : t(".hs-chartjs-tooltip").addClass("hs-chartjs-tooltip-right").removeClass("hs-chartjs-tooltip-left"),
                            n.length && n.css({
                                position: "absolute",
                                width: "2px",
                                height: a.height() - l,
    ...
    t.HSCore.components.HSJVectorMap = {
        ...
        init: function(e, a) {
            if (e.length) {
                ...
                var o = new jvm.Map(i);
                return i.tipCentered ? this.tipCentered(o.tip) : this.fixTipPosition(o.tip),
                o
            }
        },
    ...
    t.HSCore.components.HSQuill = {
        ...
        toolbarBottom: function(e, a) {
            if (a.toolbarBottom) {
                ...
                a.attach ? t(a.attach).on("shown.bs.modal", (function(t) {
                    s.css({
    ...
    t.HSCore.components.HSLeaflet = {
        ...
        init: function(e, a) {
            if (t(e).length) {
                ...
                var o = L.map(e, i.map);
                if (o.setView(i.map.coords, i.map.zoom),
                ...
                var s = t(e)
                  ...
                  , o = {
                    ...
                    beforeClose: function(e) {
                        ...
                        s.overlayBlurBg;
                        n && (a.removeClass(n.onShow).addClass(n.onHide),
    ...
    t.HSCore.components.HSList = {
        ...
        init: function(e, a) {
            if (t(e).length) {
                ...
                return r.searchMenu && t(l.list).fadeOut(0),
                l.on("searchComplete", (function() {
                    r.searchMenu && (s.searchMenu(n, r, l),
                    s.searchMenuHide(n, r, l)),
                    !r.searchMenu && r.empty && s.emptyBlock(n, r, l)
                }
                )),
        ...
        initializeHover: function(e, a, s) {
            var n, i = s, o = (t(i.list).find(".list-group-item"),
            ...
            t(o).keydown((function(e) {
                if (40 === e.which) {
                    ...
                    0 == t(i.list).children(".active").length)
                        ...
                        n = a,
                        t(i.list).height() < t(i.list).children(".active").position().top && t(i.list).scrollTop(t(i.list).children(".active").position().top + t(i.list).scrollTop())
                    }
                } else if (38 === e.which) {
                    if (e.preventDefault(),
                    0 == t(i.list).children(".active").length)
                        n = t(i.list).children().first().parent().addClass("active");
                    else if (t(i.list).children(".active").prev().length) {
                        a = t(i.list).children(".active").prev().addClass("active");
                        t(n).removeClass("active"),
                        n = a,
                        0 > t(i.list).children(".active").position().top && t(i.list).scrollTop(t(i.list).children(".active").position().top + t(i.list).scrollTop())
                    }
                } else
                    13 == e.which && o.val().length > 0 && (e.preventDefault(),
                    window.location.replace(t(n).find("a").first().attr("href")))
            }
            ))
        },
        searchMenu: function(e, a, s) {
            var n = a
              , i = s;
            if (0 === e.find("." + i.searchClass).val().length || 0 === i.visibleItems.length && !n.empty)
                t(n.empty).fadeOut(0),
                t(i.list).fadeOut(n.searchMenuDelay);
            else if (t(i.list).fadeIn(n.searchMenuDelay),
        ...
        init: function(e, a, s) {
            if (e.length) {
                ...
                return r.on("showCalendar.daterangepicker", (function(e) {
                    (o.prevArrow || o.nextArrow) && (t(".daterangepicker .prev").html(o.prevArrow),
                ...
                var s = Object.assign({}, this.defaults)
                  ...
                  , i = {
                    onStart: function(e) {
                        ...
                        if (i.result_min_target_el && "single" === i.type ? t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from) : (i.result_min_target_el || i.result_max_target_el && "double" === i.type) && (t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from),
                        t(i.result_min_target_el).is("input") ? t(i.result_max_target_el).val(e.to) : t(i.result_max_target_el).text(e.to)),
                        i.grid && "single" === i.type && t(e.slider).find(".irs-grid-text").each((function(a) {
                            var s = t(this);
                            t(s).text() === e.from && (t(e.slider).find(".irs-grid-text").removeClass("current"),
                            t(s).addClass("current"))
                        }
                        )),
                        i.secondary_target_el) {
                            i.secondary_val.steps.push(e.max + 1),
                            i.secondary_val.values.push(i.secondary_val.values[i.secondary_val.values.length - 1] + 1);
                            for (var s = 0; s < i.secondary_val.steps.length; s++)
                                e.from >= i.secondary_val.steps[s] && e.from < i.secondary_val.steps[s + 1] && (t(i.secondary_target_el).is("input") ? t(i.secondary_target_el).val(i.secondary_val.values[s]) : t(i.secondary_target_el).text(i.secondary_val.values[s]))
                        }
                    },
                    onChange: function(e) {
                        if (i.foreground_target_el) {
                        ...
                        i.secondary_target_el)
                            for (var n = 0; n < i.secondary_val.steps.length; n++)
                                e.from >= i.secondary_val.steps[n] && e.from < i.secondary_val.steps[n + 1] && (t(i.secondary_target_el).is("input") ? t(i.secondary_target_el).val(i.secondary_val.values[n]) : t(i.secondary_target_el).text(i.secondary_val.values[n]));
